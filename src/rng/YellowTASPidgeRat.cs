public class YellowTASPidgeRat : YellowForce {
    ...
    public YellowTASPidgeRat() : base(true) {
        ...
        CacheState("mtmoon", () => {
            ...
            ForceTurn(new RbyTurn("TACKLE", Crit), new RbyTurn("SMOG", Miss));
            ForceTurn(new RbyTurn("TACKLE", Crit), new RbyTurn("SMOG", Miss));
        ...
        CacheState("misty", () => {
            ...
            // MISTY
            TalkTo(4, 2);
            ForceTurn(new RbyTurn("HYPER FANG"), new RbyTurn("TACKLE", Miss));
            ForceTurn(new RbyTurn("HYPER FANG"), new RbyTurn("TACKLE", Miss));
            ForceTurn(new RbyTurn("HYPER FANG", Crit), new RbyTurn("TACKLE", Miss));
            ForceTurn(new RbyTurn("HYPER FANG", Crit), new RbyTurn("TACKLE", Miss));
            ForceTurn(new RbyTurn("HYPER FANG"), new RbyTurn("TACKLE", Miss));
        ...
        CacheState("nuggetbridge", () => {
            ...
            UseItem("TM11", "RATTATA", "TAIL WHIP");
